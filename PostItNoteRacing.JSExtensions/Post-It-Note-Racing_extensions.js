...
function mc_GetClassProperty(classIndex, propertyName) {
...
function mc_GetDriverPropertyFromClassPosition(classIndex, classPosition, propertyName) {
    ...
    let driverIndex = sc_GetTeamPropertyFromTeamIndex(teamIndex, 'ActiveDriver');

    return sc_GetPropertyFromDriverIndex(driverIndex, propertyName);
}
...
function pc_GetClassProperty(propertyName) {
    ...
    return mc_GetClassProperty(classIndex, propertyName);
}
...
function sc_GetClassPropertyFromLeaderboardPosition(leaderboardPosition, propertyName) {
    ...
    let classIndex = sc_GetTeamPropertyFromTeamIndex(teamIndex, 'Class');
...
function sc_GetPropertyFromDriverIndex(driverIndex, propertyName) {
